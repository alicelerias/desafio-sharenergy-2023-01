...
export const Search = ({ refetchUsers, setSearch, search }:any) => {
  ...
  return (
    <div className="flex flex-row sm:px-60">
     <input
        className="text-xl text-white sm:text-sm placeholder-gray-300 bg-blue-design pl-10 pr-4  border-gray-400 w-5/6 sm:h-8 py-2 focus:outline-none focus:border-blue-400" placeholder="Busque um cliente"
        type="text"
        id="search"
        name="search"
