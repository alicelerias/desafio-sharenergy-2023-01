...
export const ClientDetail = () => {
  ...
  const { data, isLoading, refetch } = useQuery("getClient", () => getClient(id), {
  ...
  return (
    <div className="flex flex-col justify-center items-center sm:w-1/3 sm:mx-auto sm:shadow-md shadow-gray-300 sm:px-2 sm: py-8 sm:border-2 border-blue-design">
      ...
      <p className="flex text-bold text-blue-design justify-center text-xl"> Cliente </p>
      ...
      <input { ...register("telefone", { required: true }) } type="number" minLength={11} maxLength={11} className={`${inputCss}`} />
